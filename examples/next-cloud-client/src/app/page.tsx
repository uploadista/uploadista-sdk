...
function App() {
  ...
  return (
    <UploadistaProvider
      ...
      storageId={process.env.NEXT_PUBLIC_UPLOADISTA_STORAGE_ID!}
    ...
    >
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        ...
        <header className="relative overflow-hidden bg-white border-b border-gray-200">
          <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 opacity-5" />
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl mb-8 p-6">
          ...
          {/* Content */}
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 transition-all duration-300 hover:shadow-xl p-8 min-h-[500px]">
