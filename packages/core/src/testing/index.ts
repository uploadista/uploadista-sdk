/**
 * Testing utilities for Uploadista packages.
 *
 * This module provides mock implementations of core services and plugins
 * for use in testing flow nodes and other Uploadista components.
 *
