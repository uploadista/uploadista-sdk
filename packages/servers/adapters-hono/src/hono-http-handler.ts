import { UploadistaRequest, UploadistaResponse } from "@uploadista/server";
import { Effect } from "effect";
import { Context, Env } from "hono";

export const extractHonoRequest = <TEnv extends Env>(c: Context<TEnv>, { baseUrl }: { baseUrl: string }) => {
  ...
  export const sendHonoResponse = (response: UploadistaResponse) =>
    Effect.sync(() => {
